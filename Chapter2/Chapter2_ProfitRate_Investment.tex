...
Diagnosing that exhaustion requires an instrument capable of
separating what the standard three-channel Weisskopf decomposition
conflates. When the relative price of output to capital goods
deteriorates sharply --- as it did in 1972--1974 under the oil shock
--- the three-channel framework absorbs that movement entirely into
the technology channel and reads it as structural deterioration in
productive efficiency. The four-channel decomposition developed in
this chapter separates real capital productivity from the
output-to-capital relative price, making it possible to distinguish
a genuine failure of relational mechanization from a geopolitical
price shock transmitted through the cost of capital goods. The
reclassification is not a refinement at the margin: 57.8 percent of
the 1972--1974 profit-rate decline is reassigned from technology
failure to a price-mediated transmission of the oil shock, clarifying
the periodization of Fordist crisis and identifying the 1966--1970
episode --- not 1972--1974 --- as the structural exhaustion of the
...
Two contributions follow from this architecture. The four-channel
decomposition reclassifies the most consequential profitability
episodes of the postwar US economy, disaggregating the 1966--1970
structural crisis --- simultaneous multi-channel contraction with
no institutional lever capable of relieving more than one pressure
at a time --- from the 1972--1974 price shock that a three-channel
framework conflates into a single technology narrative. The
distribution-conditioned identification of $\hat{\theta}(\omega)$
and $\hat{\theta}^{CL}(\omega, s^{ME})$ recovers structurally
distinct capacity utilization series for both economies without
imposing a balanced-growth assumption, and positions the comparative
analysis on a structural object --- relational mechanization under
external constraint --- whose peripheral form can be identified
independently of the US results rather than as a deviation from them.
...
The notion of spatio-temporal fixes explains the displacement of crisis tendencies geographically and temporally. It does not, however, identify the mechanism through which those tendencies are generated at the level of accumulation itself---the variable whose cumulative path constitutes the trigger rather than the displaced expression of crisis. Accounting for displacement without accounting for generation leaves the crisis theory incomplete at its productive foundation.
...
Understanding path of capacity utilization as a crisis trigger, operates at the aggregate level---it tells us that the path of $\mu_t$ is cumulatively unstable, not why individual capitalist firms are incapable of coordinating around a stable utilization rate. That is why the argument must go beyond the anarchic character of the market, and move towards the labour process itself at the firm level. 
...
these gains  came at the cost of falling profitability: what the Weisskopf 
decomposition records as a declining $\hat{\mu}_t$ from the mid-1960s 
registers not a failure of demand management but the political-economic 
contradiction of a settlement that could not simultaneously sustain full 
employment, rising real wages, and adequate profit rates. The crisis of 
Fordism was therefore the crisis of the political economy of full 
employment itself.
...
capital stock.%
% C5: footnote added
\footnote{In the empirical implementation, the theoretical $\phi_t$ is
...
The profitability analysis has established which channels drove the
Fordist profit rate, has identified the 1966--1970 three-channel
contraction as the structural crisis in which the institutional settlement
failed simultaneously across all stagnation tendency dimensions, and has
disaggregated the 1972--1974 collapse into its price-mediated and
real-productive components. What it cannot resolve --- and what the
four-channel decomposition, precisely because it is an accounting
identity, leaves structurally open --- is the direction of the
institutional causality: whether demand activation was the mechanism
that counteracted over-accumulation, or whether over-accumulation was
the structural condition that made demand activation necessary. That
question is the object of Chapter~3.
...
decisively exceeds the 1\% critical value of $60.16$
(Appendix~\ref{app:chile_stage_a}). The $m$-normalized pre-1973
...
\citep{PalmaMarcel1989}. A unit increase in the wage share compresses
...
($\hat{\alpha}_y^{R1} = -0.091$; Table~\ref{tab:cl:alpha},
Appendix~\ref{app:chile_stage_a}). The constraint does not merely
...
(Appendix~\ref{app:chile_stage_a}).
...
what the four-channel identity correctly assigns to world-market price
dynamics transmitted through the capital goods import channel.
...
The channel-level means clarify which mechanisms govern this arc. The profit
share $\bar{\pi}$ rises through the first three sub-periods --- from $0.396$
to $0.425$ to $0.477$ --- registering the capacity of ISI capital to extract
a rising surplus share as industrialization deepens. Its compression in the
Late ISI ($\bar{\pi} = 0.418$) and apparent elevation in the Crisis
...
ISI (from $0.763$ to $0.927$), registering the demand-activation dynamics
of industrialization --- but that activation cannot maintain the profit rate
when the profit share compresses. Real capital productivity $\bar{B}_r$
declines across the full arc (from $0.174$ to $0.166$ to $0.155$ to
$0.149$), reflecting the progressive erosion of the capital efficiency of
ISI investment as import-substitution opportunities were exhausted at each
technological tier. The $Py/PK$ relative price rises through Mid ISI
($\overline{Py/PK} = 1.126$) before compressing sharply in the Crisis
($\overline{Py/PK} = 0.778$), registering the capital-goods price shock of
the coup period and post-coup external adjustment.
...
The profitability analysis has established which channels governed the
Chilean profit rate across the ISI arc, has identified the 1972--1974
expansion as a distributional overdetermination episode unique to the
political economy of the Unidad Popular, and has disaggregated the
1974--1975 coup-period contraction into its coincident demand-destruction
and capital-goods price-shock components --- a disaggregation the
three-channel framework cannot perform. What it cannot resolve is
...
The three-stage architecture established this in sequence. Stage~A
identified the distribution-conditioned transformation elasticity
$\hat{\theta}(\omega) = 0.918$ at the sample mean --- the structural
over-accumulation tendency operative throughout the Fordist period,
with capital accumulating faster than productive capacity expanded
at the realized wage share. The Fordist settlement did not resolve
this tendency; it managed it through Taylorist compositional
upgrading of the capital stock, which held relational mechanization
on an ascending path ($B_r$ rising from 58.6 to 63.5 across the
Fordist transition) even as the transformation elasticity placed
downward structural pressure on the capacity frontier. Stage~B
decomposed the stagnation into its channels and regime structure.
The Fordist cycle's functional period (1951--1966) was characterized
by single-channel contractions resolvable by partial
reconfiguration; the structural crisis of 1966--1970 registered as
simultaneous multi-channel contraction --- 34.5\% distributional,
29.2\% real capital productivity, 29.8\% demand --- with no
offsetting force in any channel. The 1972--1974 contraction, by
contrast, was price-mediated: 57.8\% of the compounded decline
operated through $P_Y/P_K$ as the oil shock transmitted through
the relative capital goods price, while real productive efficiency
continued to improve ($B_r$ offset $-13.0\%$). The periodization
of Fordist crisis depends on separating these two episodes: the
structural crisis of 1966--1970 marks the exhaustion of the
institutional settlement; the world-market stagnation tendency of
1972--1974 is its external confirmation, not its cause. What the
decomposition cannot resolve --- and what no accounting identity
can resolve --- is the direction of the institutional causality:
whether demand activation counteracted over-accumulation, or
whether over-accumulation made demand activation structurally
necessary. The four-channel decomposition makes the anatomy
legible; the causal architecture of the Fordist settlement is the
object that Chapter~3 must address.
...
The Chilean results establish what the US results cannot: that the
...
$\hat{\theta}^{CL} < 1$ throughout the full ISI arc registers a
