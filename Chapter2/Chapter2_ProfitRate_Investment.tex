...
The chapter proceeds as follows. Section~\ref{sec:litreview} develops the theoretical framework through four strands --- crisis theory, spatio-temporal fixes, the aggregate crisis trigger, and the firm-level contradictions of the labour process --- that converge on the structural identification problem. Section~\ref{sec:analytical_framework} derives the four-channel decomposition, the distribution-conditioned MPF, and the causal inference strategy. Section~\ref{sec:data} describes the US and Chilean panels. Section~\ref{sec:results} presents the empirical analysis in two stages for each economy: structural identification
(Stage~A) and profitability decomposition (Stage~B). Appendices provide full derivations and estimation details.


\section{Capacity Utilization in Marxist Crisis Theory}
\label{sec:litreview}
...
\citet{Luxemburg2015} argued that capitalism cannot 
...
but uneven and combined development: the periphery is integrated into the world market on structurally subordinate terms, reproducing rather than resolving the contradictions of the center. \citet{Poulantzas2000} identified the capitalist state not as an external regulator of this process but as a social relation constitutive of it --- crisis management through the state is itself a form of the class struggle that  concentration and centralization intensify.\citet{Harvey2018} three cuts of crisis draw these strands together: (i) overaccumulation and underconsumption as cyclical phases of the capital circuit; (ii) the credit system bridging temporal gaps between production and realization; (iii) geographica reallocation displacing crisis to new spaces and future horizons as spatio-temporal fixes to crisis through uneven geographical development and new forms of imperialism \citep{Harvey2001}
...
sustain expanded reproduction. But the proof of feasibility does not carry a pattern nor a tendency. \citet{Okishio2022} stresses that the conditions required for smooth  reproduction are so stringent that decentralized, profit-oriented  capitalist decision-making cannot sustain them: the accumulation  equilibrium trajectory is not an attractor but a knife-edge. The 
...
If individual firms do not possess coherent utilization targets, the standard aggregation fails at its source. The macro variable e $\frac{Y^d}{K}$ that enters the post-Keynesian investment function has no behavioral referent. What aggregates is not a representative firm's target but the distributive struggle within each firm over how much capacity to activate, under what conditions, and for whose benefit. Aggregate $\mu_t$ is therefore an emergent property of unresolved contradictions interacting through market competition---not a deviation from a well-defined center of gravity. Pinning this discussion to the labour process, understood as productive capacities becomes operational when discussed in terms of historical contingecy of historical capitalism. This connects the interest of this essay to engage in historical political economy as a field of inquiry, studying under a regulationinst approach the structural crisis of American Fordism, to problematize the understanding of imperialism, the political economy of its scales and tendencies to geopolitical conflict as structural phenomena. The Taylorist labour process that had sustained Fordism accumulation regime as a new stage of capitalist development in which the labour process sclaed from mass production to be coupled with mass consumption, promoting labour unionization and collective wage bargaining, which rested on what \citet{Braverman1998} diagnosed as the systematic separation of conception from execution ---  the degradation of work into deskilled, routinized tasks under  managerial control. \citet{Vidal2022} shows that this diagnosis, while  correct on the discipline side, is one-sided and obscures the contradictions of capitalism development. Precisley, the same deskilling process that  secured managerial control simultaneously eroded the cooperative and  cognitive capacities on which production depended, generating a contradiction within management itself that Braverman's framework could not register. As competitive pressures shifted the basis of efficiency toward economies of scope and flexibility, the Taylorist suppression of worker cognition became not a source of stability but a fetter on 
capital accumulation. At the macro-historical dimension, these contradictions express themselves by demand-mangement to promote full employment via military keyesianism in the geopolitical context of the cold war. At first with the Korean War, and in a second moment with the Vietnam War. Near full employment, tightened labour markets, raised wages, strengthened the working class's bargaining position and militancy intensity in a broader social context post-civil right movement and anti-imperialist sentiment of the American society that would be resolved with a capitalist revolt against its own working class. Is this period od of global turbulence this essays revists. 
...
for quantitative analysis in pollitical economy \citep{Basu2018}. The interest of surplus approaches for the rate of profit, is its centrality in the relation 
of economic growth and distributive conflict. The rate of profit $r = \Pi/K$  is a variable of interest for surplus approaches, because its wide array of accounting decompositions in nested variables encompasses the entanglement of class struggle, aggregate demand, and crisis. As first introduced by \citet{Weisskopf1979}: 
...
Is straightforward but seldom highlighted that the rate of capital accumulation --- if undestood in money 
terms --- capital accumulation is the influx speed of surplus re-invested by capitalists into the capital circuit \citep{Foley1982}. 
Likewise, there is a material component embedded in the accumulation process that cannot be reduced to monetary terms. 
This tension within political economy is understood by the transformation problem of value to 
prices. Based on the seminal contribution \textit{"Production of Commodities by Means of Commodities"} by \citet{Sraffa1960}, the modern 
reconstruction of classical political economy, which encompasses different traditions within the debate of surplus approaches 
have interpreted the relation of physical quantity-inputs and the determination of prices, in a debate that seemed for many researchers as a dead avenue. I have a research priori on the New Interpretation on this debate, going further than a research prior, is out of the scope of this chapter. But interest in measurement of capital stocks, led me to settle a position of reconiliation between the notion of materiality of the labour process, but looking at money as capital in motion. Practically, it resembles the standard principles of macroeconomics distinction betweeen real versus nominal measures.

To the extend of my knowledge, this puzzle is often elevated to a analytical problem of linear algebra of input-output in 
Leontief economies --- which it is indeed, a high analytical problem--- but my studies capital stocks measurement, and the contribution by \citet{Shaikh2016} of introducing the  Generalized Perpetual Inventory Method (GPIM), have led me to settle on the following understanding: Net Capital Stocks $K^{net}_t$ are the adequate measure for  the rate of profit, but Gross Capital Stocks $K^{gr}_t$ is the adequate measure to identify the rate of capacity utilization. This is founded on an aditional layer  to rely on an unbalanced growth closure $g_Y^{p} = \theta g_K$ assuming long-run macroeconomic desiquilibrium explained by inter-departamental dispropotionality 
\textit{as a phenomenon of current prices}, while understanding the rate of capacity utilization $\mu_{t} = \frac{Y}{Y^p}$, as a mediator anchoring the monetary 
expression of value $p Y$, to the labour process represented by productive capacities $Y^p$. 

How this relates with net and gross capital stocks? By definition net capital stocks are $\Delta K_t = I_t- \delta K_t-1$, a value measure in accounting books. On the 
other hand, following  \citet{Shaikh2016} GPIM rules, gross capital stocks are defined by $\Delta K_t = I_t- z_t K_t-1$, where $ z_t $ is a rate of assets retirments
in operation that are scrapped as sudden stops. In other words, gross measures of capital can be assumed having an asset life related to the concrete form of capital "dying"
from the labour process, this means that cannot be subject to accounting policies of accelerated depreciation.  This is the case of a machine in operation that was discounted in book value, is not considered within the balance sheet of the firm, but still remains operating as means of production in the capital circuit. Hence, when relying in decomopsitions of the rate of profit, I will rely in real and current measure simultanously and to represent the temporal dimension of real terms without engaging seriously on the transformation problem but aware of it, I will represent real quantities in present prices --- or in the vecinity of the present period--- while introducing necessarily relative prices of goods and services to capital goods in the decomposition of the rate of profit, while understanding the ratio of productive capacites to real capital stocks as a problem of \textit{"quality vintage"} of capital stock in operation enclosed to the labour process where the realm of prices and money, is capital in motion imposing the material conditions of money and power. 



\subsection{Stagnation and Crisis: A Taxonomy}
\label{subsec:typology}

\citet{Basu2019} reconstruction of Marx's theory of crisis proposes a parsimonious but conceptually rich taxonomy to identify them. Intuitively, it resembles \citet{Itoh1978} theorization on excess of commodities and overaccumulation as qualitatively different types of crisis. Basu's taxonomy clasifies distinct types of crisis in Marx's works classifying in terms of deficit or excess of surplus value. 
...
The accounting decomposition identifies the channels of profit rate dynamics, but 
it cannot by itself identify why it moved through
those channels. This chapter relies on process tracing for a granularly historical 
account \citep{Collier2011}, to identify obserbable implications at each sub-period 
comprehended between \textit{"profit rate swings"}: multi-channel contractions 
and expansions that can be decomposed for the purpose of periodization, and process tracing. 

The channel decomposition provides the temporal ordering and mechanism 
required to develop causal inference using an historical method of process tracing. Building upon it, 
I leverage on cross-case small-$N$ causal analysis \citep{Mahoney2000} to assess if the structural conditons 
identified for a case study using the United States as a canonical case of financial patriach of the world system, 
enables better and more situated understanding of peripheral capitalism in historical, comparative, and relational 
perspective. If the structural conditions identified for the US in which the reproduction of profitability takes place,
operate as necessary condtiion in the case of Chile. 

The late works of \cite{Prebisch1981} 


if BoP-binding is a sufficient condition for
...
recapitalization decisions in each regime period. 
...
\input{tables/tab_B3_subperiod_US}
...
\input{tables/tab_B2_peaktotrough_US}
...
\input{tables/tab_B4_subperiod_CL}
...
\input{tables/tab_B5_peaktotrough_CL}
