...
\subsection*{A.1 Admissibility Conditions}
...
\subsection*{A.2 Short-Run Exclusion on the Interaction Term}
...
\subsection*{A.3 Restriction Test Implementation}
...
$\beta$ \citep{Johansen1991}. The unrestricted cointegrating vector,
normalized on $y$, is:
%
\begin{equation}
