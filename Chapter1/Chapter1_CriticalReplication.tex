...
% Consolidated v3 — 2026-03-16
% All fixes from LOCKED fix list applied.
% Derivation appendix material marked but not included here.
% =============================================================================

\subsection{Laws of Capital Accumulation under Unbalanced Growth}
\label{sec:accounting_laws}

% --- BRIDGE: FEASIBLE CEILING (from §1.3.1) --- [D3 applied]
...
% =========================================================================
% §3.2.2 — The Unbalanced Growth Closure
% [A1: split — title shortened, closure material moved to §3.2.3]
% =========================================================================
...
% =========================================================================
% §3.2.3 — Investment-Savings Closure
% [NEW subsection: A1 split + B3 + C1 + C2 + C6]
% =========================================================================
...
The Cambridge equation makes explicit what $\phi^p = s$ packages. Since $\phi^p \equiv I/Y^p$ and $I = s_\pi \Pi$, the investment share decomposes as:
%
\begin{equation}\label{eq:cambridge}
	\phi^p = s_\pi \cdot \pi^p
\end{equation}
%
where $s_\pi$ is the savings propensity out of profits and $\pi^p \equiv \Pi/Y^p$ is the profit share at capacity. The constant $s$ is therefore the product of a behavioral assumption (the propensity to save out of profits) and a distributional assumption (the share of capacity output appropriated as profit). Both are suppressed---held constant---under the closure imposed here. The constancy of $\phi^p$ prevents the investment channel from absorbing the $\theta$ signal: the regime's structural character passes through to the dynamics of accumulation without being filtered by distributional adjustments. Chapter~2 reopens this package: when the exploitation rate enters through $\theta(e_t)$, the profit share $\pi^p$ is no longer fixed, the product $s_\pi \cdot \pi^p$ becomes endogenous to the regime dynamics it currently holds constant, and the investment share responds to the distributional structure the scalar world suppresses.

% =========================================================================
% §3.2.4 — Accumulation Regimes and Supply-Side Instability
% [B1: renamed; C3: derivation compressed; C4: intuitive framing added;
%  C7: B(t) merged; orphaned summary moved to §3.2.6]
% =========================================================================
...
% =========================================================================
% §3.2.5 — Mechanization, Autonomous Progress, and the Limits of Shaikh's Closure
% [B4: renamed; C5: pivot sentence added; grammar fixes applied]
% =========================================================================
...
This chapter does not resolve the contradiction. It inherits it, but subjects to scrutiny by means of critical replication. This departs within Shaikh's extended closure, to find a canonical base to progress throguh different replications studies towards refining his proposal on co-integration as means to identify a rate of capacity utilizatiokn once interpreted his framework under an unbalanced growth closure. 
...
% =========================================================================
% §3.2.6 — Summary
% [Absorbs orphaned summary from old §3.2.4; C2 applied]
% =========================================================================
...
The empirical task is now defined: identifying the transformation elasticity $\theta(\Lambda)$ and estimating it from observed data, moving towards being tested on regime dependence. The next section develops Shaikh's identification strategy for this recovery, operating within his extended closure and the ARDL bounds-testing framework, showcasing the limits of single equation of single equation models for co-integration frameworks by discussing researcher decision making for model preference, under conditions of uncertaininty.
