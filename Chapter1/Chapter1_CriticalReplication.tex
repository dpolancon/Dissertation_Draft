...
\subsection{Confinement under Uncertainty}
\label{sec:confinement_architecture}

The critical replication confines Shaikh's identification along two axes: specification uncertainty and estimator structure. The question is whether the capacity anchor is a property of the data or of the researcher's choices. Each stage opens where the previous one broke.
% =============================================================================
